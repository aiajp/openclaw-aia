...
AIA社内のObsidian Vault（`/Users/akkey/Documents/Artifacts/`）と連携し、
...
```
VAULT_PATH = /Users/akkey/Documents/Artifacts/
daily_note = VAULT_PATH + "01-Daily/" + YYYY-MM-DD + ".md"
```
...
- Vault全体のバックアップはiCloud同期に依存（本スキルでは管理しない）
